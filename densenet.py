...
MODEL_PATH = os.path.join(BASE_OUTPUT, "ijcai_verify/models/aiims_densenet_again.pt")
...
train_dataloader_b = torch.utils.data.DataLoader(dataset_b, batch_size=64, shuffle=True, num_workers=4)
valid_dataloader_b = torch.utils.data.DataLoader(dataset_v, batch_size=64, shuffle=True, num_workers=2)
...
torch.save(best_model_wts, 'ijcai_verify/models/aiims_densenet_again.pt')
...
plt.savefig('ijcai_verify/graphs/densenet121_aiims_10_001.jpg')
